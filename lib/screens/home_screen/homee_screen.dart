...
import 'package:fitfood/screens/home_screen/bloc/homerecipes_bloc.dart';
import 'package:fitfood/screens/home_screen/widgets/food_type_widget.dart';
    ...
    return ListView(
      ...
      children: [
        ...
        Padding(
          ...
          child: header("Popular Breakfast", "breakfast"),
        ),
        const SizedBox(height: 10),
        DelayedDisplay(
