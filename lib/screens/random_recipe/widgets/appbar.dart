...
import 'package:fitfood/screens/random_recipe/widgets/favorite_button.dart';
...
class _AppBarWidgetState extends State<AppBarWidget> {
  Future<Uri> data() async {
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: 'https://fitfood.page.link/',
      link: Uri.parse(
          'https://ansh-rathod-blog.netlify.app/?id=${widget.info.id}'),
      androidParameters: AndroidParameters(
        packageName: 'com.aliret.fitfood'
      ),
      ...
      actions: [
        InkWell(
          onTap: () async {
            ...
            Share.share(
              AppLocalizations.of(context)!.check_out_This_tasty_recipe+' $url',
            );
          },
          child: Container(
            width: 40,
