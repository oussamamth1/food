        ...
        child: CustomScrollView(
          slivers: [
            SliverPersistentHeader(
              delegate: MySliverAppBar(expandedHeight: 270, info: widget.info),
              pinned: true,
            ),
            SliverToBoxAdapter(
              child: Column(
                  ...
                  children: [
                                  ...
                                  children: [
                                    Text(
                                        ...
                                        style: const TextStyle(
                                            ...
                                            fontSize: 20)),
                                    Text(
                                      AppLocalizations.of(context)!.ready_in,
                                      style: TextStyle(
                                  ...
                                  children: [
                                    Text(widget.info.pricePerServing.toString(),
                                        style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 20)),
                                    Text(AppLocalizations.of(context)!.price_Servings,
                                        style: TextStyle(
                                            color: Colors.grey.shade600))
                                  ],
                                ),
                    ...
                    if (widget.similarlist.isNotEmpty)
                      Padding(
                        ...
                        child: Text(AppLocalizations.of(context)!.similar_items,
                            style: const TextStyle(
                                fontWeight: FontWeight.bold, fontSize: 20)),
                      ),
                    if (widget.similarlist.isNotEmpty)
